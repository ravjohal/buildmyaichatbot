...
export default function CreateChatbot() {
  ...
  const [formData, setFormData] = useState<Partial<InsertChatbot> & {
    ...
    liveAgentHoursEnabled: "false",
    liveAgentStartTime: "09:00",
    liveAgentEndTime: "17:00",
    liveAgentTimezone: "America/New_York",
    liveAgentDaysOfWeek: ["monday", "tuesday", "wednesday", "thursday", "friday"],
